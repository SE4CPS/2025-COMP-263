/**
 * Minimal API to ingest Lab-2 IndexedDB rows into the shared Mongo "lake".
 * Stamps every document with author info.
 */
...
app.listen(PORT, () => {
  console.log(`🌊 Lake server listening on http://localhost:${PORT} (author=${AUTHOR})`);
});