...
def get_dashboard_data():
    ...
    try:
        ...
        if cached_data:
            ...
            daily_data = clickhouse_etl.get_daily_averages(90)
            ...
            monthly_data = clickhouse_etl.get_monthly_averages(12)
            daily_data = clickhouse_etl.get_daily_averages(90)
            ...
            if monthly_data:
                ...
                total_humidity = sum(d['avg_humidity_percent'] for d in monthly_data if d['avg_humidity_percent'])
                ...
                return jsonify({
                    'overall_averages': {
                        ...
                        'avg_humidity_percent': total_humidity / count if count > 0 else None,
                        'period_months': count
                    },
